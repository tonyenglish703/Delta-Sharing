...
course_config = CourseConfig(course_code = "itds",                  # The abbreviated version of the course (4 chars preferred)
                             ...
                             supported_dbrs = ["12.2.x-scala2.12", "12.2.x-photon-scala2.12", "12.2.x-scala2.12", "12.2.x-photon-scala2.12"],
                             expected_dbrs = "12.2.x-scala2.12, 12.2.x-photon-scala2.12, 12.2.x-scala2.12, 12.2.x-photon-scala2.12")
